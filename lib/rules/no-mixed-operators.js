...
function normalizeOptions(options) {
    ...
    return {
        groups: groups,
        ignoreSamePrecedence: Boolean(options && options.ignoreSamePrecedence)
    };
}
...
module.exports = {
    meta: {
        docs: {
            description: "Disallow mixes of binary operators.",
    ...
    create: function(context) {
        ...
        function reportBothOperators(node) {
            ...
            var message =
                "Unexpected a mix of '" + left.operator + "' and '" +
                right.operator + "'.";
